...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create table 'Smj_zohocrm_map'
         */
        $table = $installer->getConnection()
        ->newTable($installer->getTable('smj_zohocrm_map'))
        ->addColumn(
            'id',
            Table::TYPE_SMALLINT,
            null,
        ...
        $table = $installer->getConnection()->newTable(
            $installer->getTable('smj_zohocrm_field')
        )->addColumn(
            'id',
            Table::TYPE_INTEGER,
            null,
         ...
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('smj_zohocrm_report')
        )->addColumn(
            'id',
            Table::TYPE_INTEGER,
            null,
