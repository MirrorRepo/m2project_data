define([
    ...
    return SingleCheckbox.extend({
        ...
        emailObserver: function (conmonent) {
            this.visible(!conmonent.isPasswordVisible());

            conmonent.isLoading.subscribe(function (isLoading) {
                if (isLoading === true) {
                    $.when(conmonent.isEmailCheckComplete).done(function () {
                        this.visible(true);
