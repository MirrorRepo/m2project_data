...
require(['jquery','jquery/ui'],function($){$(document).on("click",".color .swatch-option",function(){var color=$(this).attr('option-label');$('.catalog-product-view .product-info-main .product-info-price .color-name').remove();if($(this).hasClass('selected')){$('.catalog-product-view .product-info-main .product-info-price .price-box').append("<span class='color-name'>"+color+"</span>");}
if($('.color .swatch-option').length==1){$('.color .swatch-option').click(false);}});});