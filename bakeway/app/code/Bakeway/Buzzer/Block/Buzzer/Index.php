...
class Index extends \Magento\Framework\View\Element\Template {
   ...
   */
    ...
    public function getVendorData() {
        ...
        $maintable =  $marketPlaceOrder->getConnection()->getTableName('marketplace_orders');
        $secondtable =  $marketPlaceOrder->getConnection()->getTableName('sales_order');
        $marketPlaceOrder->getSelect()->join( array('ot'=>'sales_order'),  'main_table.order_id = ot.entity_id', array('ot.entity_id'));
