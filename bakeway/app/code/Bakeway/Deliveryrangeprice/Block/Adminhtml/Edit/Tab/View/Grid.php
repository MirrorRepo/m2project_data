   ...
   /**
    ...
    protected function _prepareCollection()
    {
       try
       {
            ...
            $blockObj= $this->getLayout()->createBlock('Bakeway\StoreCatalog\Block\Adminhtml\Customer\Edit\Tab\Storecatalog');
            $sellerStores = $blockObj->getSellerData();
            $defaultStore = current($sellerStores);
            if (empty($storeId) or $storeId == "")
            ...
            $collection->getSelect()->joinLeft(
                ...
                ['shop_title'])*/
            ->joinLeft(['partner' => $collection->getTable('bakeway_partner_locations')],
                'main_table.store_id = partner.id',
                ['store_locality_area']);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
         ...
         $this->addColumn(
             'midnight_price',
             [
                 'header' => __('Midnight Delivery Price'),
                 'type' => 'number',
                 'index' => 'midnight_price',
                 'header_css_class' => 'col-id',
                 'column_css_class' => 'col-id'
             ]
         );
         ...
         $this->addColumn(
             'morning_price',
             [
                 'header' => __('Early Morning Delivery Price'),
                 'type' => 'number',
                 'index' => 'morning_price',
                 'header_css_class' => 'col-id',
                 'column_css_class' => 'col-id'
