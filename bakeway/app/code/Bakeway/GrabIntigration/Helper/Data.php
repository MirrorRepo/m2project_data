...
use SplashLab\CorsRequests\Helper\Data as SplashLabHelper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    */
     ...
     * @param SplashLabHelper $splashlabhelper
     */
    ...
    SplashLabHelper $splashlabhelper,
    LocationCollection $locationCollection
        ...
        $this->splashlabhelper = $splashlabhelper;
    ...
    */
    ...
    {
        $corsOriginUrl = $this->splashlabhelper->getCorsAccessControlUrl();

        if($corsOriginUrl && $corsOriginUrl != "")
          $corsOriginUrl = rtrim($corsOriginUrl,"/");
   ...
   public function outForDeliveryStatusGrabApiCall($order,$sellerId)
   {
     ...
     * @param $code
     */
    public function getFourNotFoundExpection($message, $code = null)
    {
        $corsOriginUrl = $this->splashlabhelper->getCorsAccessControlUrl();
        if($corsOriginUrl && $corsOriginUrl != "")
          $corsOriginUrl = rtrim($corsOriginUrl,"/");
