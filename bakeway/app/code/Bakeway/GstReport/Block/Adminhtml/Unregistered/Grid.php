    ...
    extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'total_order_amt_igst',
            [
                'header' => __('IGST'),
                'type' => 'text',
                'filter' => false,
                'index' => 'total_order_amt_igst',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
                'renderer' => 'Bakeway\GstReport\Block\Adminhtml\Unregistered\Renderer\OrderAmountIGST'
            ]
        ...
        $this->addColumn(
            ...
            [
                ...
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
                'renderer' => 'Bakeway\GstReport\Block\Adminhtml\Unregistered\Renderer\IGST'
            ]
        ...
        $this->addColumn(
            ...
            [
                ...
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
                'renderer' => 'Bakeway\GstReport\Block\Adminhtml\Unregistered\Renderer\FeeIGST'
            ]
        ...
        $this->addColumn(
            'total_igst',
            [
                'header' => __('TOTAL IGST'),
                'type' => 'text',
                'filter' => false,
                'index' => 'total_igst',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
                'renderer' => 'Bakeway\GstReport\Block\Adminhtml\Unregistered\Renderer\TotalIGST'
            ]
