...
class OrderAmountIGST extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    public function render(DataObject $row)
    {
        ...
        {
            $totalIgst = "NA";
            $row->setOrderAmountIGST($totalIgst);            
        }
        else
        {
            $totalIgst = $row->getTotalAmount() * 0.18;
            $row->setOrderAmountIGST($totalIgst);
        }
