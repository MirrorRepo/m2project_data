    ...
    protected function _prepareCollection()
    {
        try {
           ...
           // print_r($collection->getData());
            ...
            /**condition for store count specific**/
           /* $storeCount =  count($collection);
            $sellerData = $this->marketplacehelper->getSellerEntityId($this->getCustomerId());
            ...
            if($storeCount == 1):
                ...
                $newStoreLocalityArea = $this->partnerlocationHelper->getSingleLocality($this->getCustomerId());
           ...
           if($oldIsConglomerate !=  $newisCognglomarate ||  $oldStoreLocalityArea != $newStoreLocalityArea)
           {
               $locality = $this->partnerlocationHelper->getSingleLocality($this->getCustomerId());
               $this->productApiHelper->createVendorUrl($this->getCustomerId(),$locality);
               $this->productApiHelper->createSellerAllProductUrls($this->getCustomerId(),$locality);
               $this->_redirect('customer/index/edit/', array('id' => $this->getCustomerId(),'_current' => true,'mode'=>'localtion_save_target'));
           }
           */
 ...
 //=========BKWYADMIN-1206 : Is featured? status setting========//
        $this->addColumn(
            ...
            [
                ...
                'index' => 'is_featured',
                'options' => $this->_cmsPage->getAvailableStatuses(),
                'filter_index'=>'main_table.is_featured',
            ]
        );
 //===============================================================//
        $this->addColumn(
