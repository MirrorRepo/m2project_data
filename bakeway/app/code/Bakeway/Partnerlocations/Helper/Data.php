...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
     ...
     */
    public function __construct(\Magento\Framework\App\Helper\Context $context, LocationsCollection $locationsCollection, SublocationsCollection $sublocationsCollection
    ) {
    ...
    public function getSellerIdFromStoreName($storeUnquieName) { 
   
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $collectionLocation = $objectManager->create('\Bakeway\Partnerlocations\Model\ResourceModel\Partnerlocations\Collection');
        $collection = $collectionLocation
                ->addFieldToSelect(['seller_id'])
                ->addFieldToFilter('store_unique_name', ["eq" => $storeUnquieName])
                ->addFieldToFilter('is_active', 1)
                ->getLastItem();
        return $collection->getData('seller_id');
    }
