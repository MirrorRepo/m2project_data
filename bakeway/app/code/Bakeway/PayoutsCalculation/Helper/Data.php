...
class Data extends AbstractHelper
{
    ...
    {
        /**
         * get delivery fee excl tax
         * @var float $deliveryFeeInclTax
         */
        $deliveryFeeExclTax = $this->getDeliveryFeeExclTax($deliveryFeeInclTax);
        /**
         * get tcs setting value from admin side
         */
    ...
    { 
       /**
        * get configured delivery fee tax percantage
        * i.e 18%
        */
    ...
    public function getUnpaidOrderCollection() {
       ...
       //['created_at']);
        ...
        // $orderCollection->getSelect()->where('sosh.created_at >= "2018-08-02"');
         ...
         $orderCollection->getSelect()->group("mp_sl.order_item_id");
