        ...
        if (!empty($csvRows)) {
            ...
            foreach ($csvRows as $csvRow) {
                ...
                if (isset($csvRow[0])) {
                    ...
                    $tcsAmount = $csvRow[26];
                    $cityName = $csvRow[27];
                    $orderStatus = $csvRow[28];
                    $actualSellerAmount = $csvRow[29];
                    $paidStatus = $csvRow[30];
                    $completedAt = $csvRow[31];
                    ...
                    if (isset(($customMessage[0])) && !empty($customMessage[0])):
                    ...
                    foreach ($_items as $_item) {
                        ...
                        if (!empty($getSku)) {
                            ...
                            $csvRow[37] = $tcsAmount;
                            $csvRow[38] = $cityName;
                            $csvRow[39] = $orderStatus;
                            $csvRow[40] = $actualSellerAmount;
                            $csvRow[41] = $paidStatus;
                            $csvRow[42] = $completedAt;
                        }
