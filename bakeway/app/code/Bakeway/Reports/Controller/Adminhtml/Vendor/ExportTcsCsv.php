...
class ExportTcsCsv extends Action
{
    /**
   ...
   /**
    ...
    public function execute()
    {
        ...
        $fileName   = 'tcsReport '.date("d-m-Y h:i:s ").'.csv';
        $content = $this->resultPage->getLayout()->createBlock('Bakeway\Reports\Block\Adminhtml\Tcs\Grid')->getCsv();
