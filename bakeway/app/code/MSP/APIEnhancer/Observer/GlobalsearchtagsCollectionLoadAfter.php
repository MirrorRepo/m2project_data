...
class GlobalsearchtagsCollectionLoadAfter implements ObserverInterface
{
    /**
     * @var TagInterface
     */
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $tags = ['global_tags_search'];
        foreach ($collection as $searchtags) {
           $tags[] = 'global_tags_search' . $searchtags->getData('entity_id');
        }
