...
class Edit extends \Magento\Backend\Block\Widget {
    ...
    \Magento\Backend\Block\Widget\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\ObjectManagerInterface $objectManager, CountryCollection $country, \Magento\Directory\Model\Currency $currency, \Webkul\Marketplace\Helper\Data $helper, array $data = []
    ) {
    ...
    public function getContractInfoCollection() {
        $customerId = $this->getRequest()->getParam('id');
        $data = [];
        if ($customerId != '') {
            $collection = $this->_objectManager->create(
