    ...
    public function initForm() {
      ...
      /*  $fieldset->addField(
        ...
        $fieldset->addField(
            ...
            'data-form-part' => $this->getData('target_form'),
            'label' => __('Seller Static Rating'),
            'title' => __('Seller Static Rating'),
            'value' => $partner['average_ratings'],
                ]
        );
           ...
           $fieldset->addField(
            ...
            'name' => 'marketing',
            'data-form-part' => $this->getData('target_form'),
            'label' => __('Bakery Offers'),
            'title' => __('Bakery Offers'),
        ...
        $fieldset->addField(
            ...
            'title' => __('Brand'),
            'value' => $brandVal,
            'values' => $this->_marketplaceHelper->getBrandOptionArray(),
                ]
        );
       ...
       /* $fieldset->addField(
        ...
        /*
         * Removed Store Open/Close Timing as this will be Store Specfic from now.
         */
        /*$fieldset->addField(
       ...
       /* $fieldset->addField(
        ...
        /*
         * Removed Store Delivery Timing as this will be Store Specfic from now.
         */
        /*$fieldset->addField(
