    ...
    { 
        ...
        foreach ($collection as $item) {
            ...
            $receiverInfo = [
 	        ...
 	        $emailTempVariables['myvar1'] = $item->getSellerId();
            ...
            if(!empty($dissStoremail)):
                ...
                $this->_objectManager->get('Webkul\Marketplace\Helper\Email')->sendDispprovedSellerEmail($all_EmailAddress,$emailTempVariables, $senderInfoCustom);
            endif;
            /* end */
    ...
    protected function _getAclResource()
    {
       $action = strtolower($this->getRequest()->getActionName());
        ...
        switch ($action) {
            case 'index':
            case 'massdisapprove':
                $aclResource = 'Webkul_Marketplace::massdisapprove';
                break;
          }
        return $aclResource;
    }
