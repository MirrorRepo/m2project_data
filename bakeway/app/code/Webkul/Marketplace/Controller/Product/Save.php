        ...
        if ($isPartner == 1) {
            try {
                ...
                if ($this->getRequest()->isPost()) {
                     ...
                     */
                    if(isset($wholedata['product']['advance_order_intimation_unit']) && $wholedata['product']['advance_order_intimation_unit'] == 1)
                    {
                        $wholedata['product']['advance_order_intimation_unit'] = 2;
                        if(isset($wholedata['product']['advance_order_intimation']) && $wholedata['product']['advance_order_intimation'] > 0)
                        {
                            $wholedata['product']['advance_order_intimation'] = ($wholedata['product']['advance_order_intimation'] * 60);
                        }

                    }
                    if (!empty($wholedata['product']['likely_available'])):
                        $wholedata['product']['likely_available'] = 1;
                    else:
                        $wholedata['product']['likely_available'] = 0;
                    endif;
