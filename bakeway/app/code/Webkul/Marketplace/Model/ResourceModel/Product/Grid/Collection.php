...
class Collection extends ProductCollection implements SearchResultInterface
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->joinInner(array('mkud' => 'marketplace_userdata'), 'mkud.seller_id = main_table.seller_id', array());
        $this->getSelect()->joinLeft(array('bkc' => 'bakeway_cities'), 'bkc.id = mkud.store_city', array('bkc.id'));
       
        $this->addFilterToMap("seller_id", "mkud.seller_id");
        $this->addFilterToMap("id", "bkc.id");
