...
class Dompdf
{
    ...
    */
    ...
    public function __construct($options = null)
    {
	    ...
	    $this->setCanvas(Dompdf::get_instance($this, $this->paperSize, $this->paperOrientation));
    ...
    public function render()
    {
        ...
        foreach ($this->tree->get_frames() as $frame) {
            ...
            if (is_null($root)) {
                $root = Dompdf::decorate_root($this->tree->get_root(), $this);
                continue;
            }

            // Create the appropriate decorators, reflowers & positioners.
            Dompdf::decorate_frame($frame, $this, $root);
        }
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        if ($display === "list-item") {
            ...
            $deco->prepend_child(Dompdf::decorate_frame($b_f, $dompdf, $root));
        }
