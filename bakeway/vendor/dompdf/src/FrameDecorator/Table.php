        ...
        while ($iter) {
            ...
            if ($anon_row) {
                ...
                if ($display === "table-cell") {
                    ...
                    $table_row_group = DompdfPatch::decorate_frame($frame, $this->_dompdf, $this->_root);
                    ...
                    $table_row = DompdfPatch::decorate_frame($frame, $this->_dompdf, $this->_root);
